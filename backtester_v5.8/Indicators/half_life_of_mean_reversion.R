...
#How to call:
#half_life_open <- lapply(inSampleDataList, function(series){
  #result <- calculateHalfLife(series$Open)
#})
#half_life_close <- lapply(inSampleDataList, function(series){
  #result <- calculateHalfLife(series$Close)
#})
...
#for(i in 1:10){
  ...
  #print(half_life_open[[i]]$HalfLife_WithIntercept)
  #print("No Intercept:")
  #print(half_life_open[[i]]$HalfLife_NoIntercept)
  #print("Time series:", i)
  #print("Open:")
  #print("With Intercept:")
  #print(half_life_close[[i]]$HalfLife_WithIntercept)
  #print("No Intercept:")
  #print(half_life_close[[i]]$HalfLife_NoIntercept)
#}
